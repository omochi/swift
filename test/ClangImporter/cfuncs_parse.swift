...
#endif
  _ = f as Float
  cfunc2(b:17, a:i) // expected-error {{extraneous argument label 'b:' in call}}
  // expected-error@-1 {{extraneous argument label 'a:' in call}}
  // expected-error@-2 {{cannot convert value of type 'Int' to expected argument type 'Int32'}}
